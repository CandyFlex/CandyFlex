...
<table>
  <tr>
    ...
    <td valign="top">
      ...
      <p>Name a town and a trade. Disrepair reads every listed business website once, politely, and shows which ones are failing their owners: a page that is gone, a number a caller cannot tap, a menu locked in a PDF. Every finding carries the measurement it rests on.</p>
      <p>
